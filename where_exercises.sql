...
-- q5
SELECT emp_no, first_name, last_name FROM employees WHERE last_name LIKE 'E%' ORDER BY last_name;
	-- 7330
...
-- q7
SELECT emp_no, first_name, last_name FROM employees WHERE last_name LIKE 'E%e';
	-- 899 start AND end with 'e'.
	-- 24292 end with 'e'.
	
-- q8
SELECT first_name, last_name, hire_date FROM employees WHERE hire_date > '1989-12-31' AND hire_date < '2000-01-01';
	-- 135214
	
-- q9
SELECT first_name, last_name, birth_date FROM employees WHERE birth_date LIKE '%-12-31';
	-- 818

-- q10
SELECT first_name, last_name, birth_date, hire_date FROM employees WHERE hire_date > '1989-12-31' AND hire_date < '2000-01-01' AND birth_date LIKE '%-12-31';
	-- 358
